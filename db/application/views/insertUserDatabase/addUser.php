...
<body>
	...
	<!-- end navbar -->
	<?php if ($this->session->flashdata(md5('duplikat')) || $this->session->flashdata(md5('gagal')) || $this->session->flashdata(md5('salah')) ) : ?>
	<!-- Modal -->
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<?php echo $this->session->flashdata(md5('salah'));?>
...
<div class="row" style="margin-top:70px;">
	...
	<div class="col-11 mt-3">
		...
		<div class=" h5 font-weight-normal alert alert-success" style="width:95%;">
			...
			Add another user for MySQL database
		</div>
		<div class="row">
			<div class="col-5">
				<form action="<?= base_url('UserData/addUserDb') ?>" method="post" id="register">
					...
					<div class="input-group mb-2">
						<input type="password" id="password" name="password" class="form-control" id="inlineFormInputGroup">
						<?= form_error('password'); ?>
					</div>
					<h5 class="font-weight-bold"> Password (again):</h5>
					<div class="input-group mb-2">
						<input type="password" name="password_conf" class="form-control" id="inlineFormInputGroup">
		...
		<div class="col-7">
			<form action="<?php echo base_url('UserData/generate') ?>" method="post">
				<a href="<?= base_url('UserData/generateUser')?>"><button class="btn btn-sm btn-light" style="box-shadow:1px 1px 3px rgba(0,0,0,0.25); margin-top: 285px;">Password
				Generator</button></a>
			</form>
		</div>
	</div>
