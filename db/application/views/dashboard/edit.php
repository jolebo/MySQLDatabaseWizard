	...
	<div class="row" style="margin-top:70px;">
		...
		<div class="col-11 mt-3">
			...
			<div class=" h5 font-weight-normal alert alert-success" style="width:95%;">
				...
				Change Privileges "<?php echo $user['User']; ?>"
			</div>
			<div>
				user.<b><?php echo $user['User'] ?></b><br>
				database.<b><?php echo $db['Db'] ?></b>
			</div>
			<form action="<?= base_url('dashboard/insertAkses') ?>" method="post">
				<table class="table table-hover table-striped" style="width:98%; float:left">
					...
					<tbody>
						<tr class="tr">
							<td class="td">
								<input type="hidden" name="database" value="<?php echo $db['Db'] ?>">
								<input type="hidden" name="user" value="<?php echo $user['User'] ?>">
								<input type="checkbox" name="akses[]" value="ALTER"> ALTER </td>
