...
<body>
	...
	<div class="row" style="margin-top:70px;">
		...
		<div class="col-11 mt-3">
			...
			<h2 class="font-weight-normal mt-4"> Step 4 : Complete the task</h2>
			...
			<div class=" h5 font-weight-normal alert alert-success" style="width:95%;">
				...
				User "<?php echo $user['User'] ?>" was added to the database "<?php echo $db['SCHEMA_NAME'] ?>"
			</div>
