...
<body>
	...
	<div class="row" style="margin-top:70px;">
		...
		<div class="col-11 mt-3">
			...
			<h2 class="font-weight-normal mt-4">Manage Database</h2>
			<table cellpadding="20" cellspacing="10" align="center" class="hovertable">
				...
				<?php foreach($db as $row) : ?>
					<tr>
						...
						<td></td>
						<td><?= anchor('dashboard/dropDb/'.$row["SCHEMA_NAME"],'DROP DATABASE');?> |
							<?= anchor('dashboard/SelectUsr/'.$row["SCHEMA_NAME"],'ADD USER TO THIS DB');?> | <?= anchor('dashboard/Selectdata/'.$row["SCHEMA_NAME"],'MANAGE TABLE');?> </td>
					</tr>
				<?php endforeach; ?>
			</table>
