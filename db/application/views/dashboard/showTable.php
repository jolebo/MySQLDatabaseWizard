	...
	<div class="row" style="margin-top:70px;">
		...
		<div class="col-11 mt-3">
			...
			<div class=" h5 font-weight-normal alert alert-success" style="width:95%;">
				...
				</div>Manage Your Database Tables
			</div>
			<h2 class="font-weight-normal mt-4">Manage Table</h2>
			<h5><?= anchor('Table/data/'.$row["SCHEMA_NAME"],'Create Table');?></h5>
			<table cellpadding="20" cellspacing="10" align="center" class="hovertable">
				<tr>
					<th colspan="2">Table Name</th><th>Action</th>
				</tr>
				<?php foreach($table as $row) : ?>
				<tr>
					<td colspan="2"><?= $row['TABLE_NAME'] ?></td>
					<td><?= anchor('table/checkTable/'.$row["TABLE_NAME"],'Table Structure');?></td>
				</tr>
			<?php endforeach; ?>
			</table>
